# config_alternative.py - Configuración alternativa si el puerto 465 está bloqueado
# Copiar el contenido de este archivo a config.py si los emails no funcionan
...
class Config:
    ...
    # CONFIGURACIÓN SMTP ALTERNATIVA - Usar si el puerto 465 está bloqueado
    MAIL_SERVER = 'smtp.gmail.com'
    MAIL_PORT = 587  # Puerto alternativo (TLS)
    MAIL_USE_TLS = True  # TLS en lugar de SSL
