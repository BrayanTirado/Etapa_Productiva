...
def create_app():
    ...
    # 2. Configuración de seguridad: establece una clave secreta aleatoria para manejar sesiones y cookies seguras
    app.config['SECRET_KEY'] = os.urandom(24)

    # 3. Carga configuraciones adicionales desde el archivo config.py (clase Config)
